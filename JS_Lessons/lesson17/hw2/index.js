...
console.log(getPopulation.apply({ countryName: country.countryName }, [43000]));
...
transaction.printTransaction.call({
  ...
  currency: anotherTransaction.currency,
  operation: anotherTransaction.operation,
  exchange: anotherTransaction.exchange,
});
